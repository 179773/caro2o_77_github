<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="employeeList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="员工手机号" align="center" prop="phone" />
      <el-table-column label="员工年龄" align="center" prop="age" />
      <el-table-column label="员工邮箱" align="center" prop="email" />
      <el-table-column label="员工地址" align="center" prop="address" />
      <el-table-column label="员工职位" align="center" prop="position" />
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除员工管理2编号为"' + ids + '"的数据项？').then(function() {
