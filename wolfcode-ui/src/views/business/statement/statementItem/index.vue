            ...
            <el-row :span="24" class="service_item_box">
              ...
              <div style="height: 300px; overflow-y: scroll;">
                <el-table :data="consumptionList" style="width: 100%">
                  ...
                  <el-table-column prop="itemPrice" label="服务价格"></el-table-column>
                  <el-table-column prop="itemQuantity" label="数量"></el-table-column>
                  <el-table-column label="操作" align="center" v-if="!customer.status">
                    <template slot-scope="scope">
                      <el-button size="mini" icon="el-icon-plus" type="primary" @click="plusHandle(scope.$index)"></el-button>
                      <el-button size="mini" icon="el-icon-minus" type="danger" @click="minusHandle(scope.$index)"></el-button>
                    </template>
                  </el-table-column>
                </el-table>
              </div>
              ...
              <el-col :span="24" class="service_list_box">
                <div style="height: 300px; overflow-y: scroll;">
                  <el-table :data="serviceItemList" style="width: 100%">
                    ...
                    <el-table-column prop="originalPrice" label="服务价格"></el-table-column>
                    <el-table-column label="操作">
                      <template slot-scope="scope">
                        <el-button size="mini" icon="el-icon-plus" type="primary" @click="serviceItemPlus(scope.row)"></el-button>
                      </template>
                    </el-table-column>
                  </el-table>
                </div>
...
<script>
  ...
  export default {
    name: "StatementItem",
    dicts: [ "item_serv_package", "appoint_serv_type"],
    data() {
      return {
        //优惠价格
        discountAmount: 0,
