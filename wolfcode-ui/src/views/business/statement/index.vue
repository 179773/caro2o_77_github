<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['business:statement:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="statementList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="预约用户" align="center" prop="appointmentId" :formatter="formatterApp" />
      <!-- :formatter="row=>row.appointmentId?'是':'否'" -->
...
export default {
  name: "Statement",
  dicts: ['statement_status', 'appoint_serv_type'],
  data() {
    return {
      // 遮罩层
      loading: true,
  ...
  methods: {
    ...
    const id =row.id;
    this.$router.push({
        path:"/business/statementItem/index/" + id
    })
    },
    formatterApp(row){
      return row.appointmentId ? '是' : '否'
    },
